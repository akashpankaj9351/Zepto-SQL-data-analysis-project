...
This is my recreation of a real-world SQL data analyst project based on an e-commerce inventory dataset scraped from [Zepto](https://www.zeptonow.com/) — one of India's fastest-growing quick-commerce startups. I built this project by following [Amlan Mohanty's YouTube tutorial](https://www.youtube.com/@amlanmohanty1) to practice real-world SQL workflows — from raw data exploration to business-focused analysis.
...
4. **Follow the [original tutorial](https://www.youtube.com/watch?v=x8dfQkKTyP0&list=PLAx-M6Di0SisFJ1rv5M_FRHUlGA5rtUf_&index=2) for a full walkthrough of the concepts.**
...
This project was built while following [Amlan Mohanty's](https://www.youtube.com/@amlanmohanty1) excellent tutorial on SQL data analysis using a real-world Zepto dataset. Go check out his channel for more hands-on SQL and data analytics content!
